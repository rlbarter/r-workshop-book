...
Let's load an actual .csv file. If you are working in a quarto document or an R script on your computer, take note of where you saved it. Create a new folder called "data" in the same location as your current document. Then [download the gapminder dataset](https://raw.githubusercontent.com/rlbarter/r-book/refs/heads/main/data/gapminder.csv) and move it to your new "data" folder.
<a href="https://raw.githubusercontent.com/rlbarter/r-book/refs/heads/main/data/gapminder.csv" download>Download CSV</a>
